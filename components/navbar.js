      ...
      <nav className={`fixed top-0 left-0 right-0 z-50 bg-main shadow-md py-4 transition-transform duration-300 ${show ? 'translate-y-0' : '-translate-y-full'}`}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <Link href="/spotlight" className={`nav-link relative pb-1 hover:pb-2 after:content-[''] after:absolute after:w-full after:h-0.5 after:bottom-0 after:left-0 after:bg-accent after:transition-transform after:duration-300 ${isActive('/spotlight') ? 'pb-2 after:scale-x-100' : 'after:scale-x-0 after:origin-bottom-right hover:after:scale-x-100 hover:after:origin-bottom-left'}`}>Spotlight</Link>
        ...
        >
          <div className="px-4 py-3 space-y-0">
            ...
            <Link href="/spotlight" className={`block px-3 py-3 border-b border-border transform transition-all duration-200 text-center hover:bg-border ${isActive('/spotlight') ? 'bg-border text-accent' : 'text-primary'}`}>Spotlight</Link>
